...
public class JumpBar : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(NewPlayer.Instance.Inventory.CoinAmount < UpgradeJumpPowerPrice)
        {
    ...
    public void JumpPowerUpgrade()
    {
        if(NewPlayer.Instance.Inventory.CoinAmount >=  UpgradeJumpPowerPrice)
        {
            NewPlayer.Instance.playermovement.jumpSpeed += 0.8f;
            NewPlayer.Instance.Inventory.RemoveCoins(UpgradeJumpPowerPrice);
